      ...
      <section className="pt-32 pb-24 md:pt-40 md:pb-32 text-center relative overflow-hidden bg-gray-950">
        ...
        <div className="container mx-auto px-6 relative">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
            <button onClick={() => signIn("github", { callbackUrl })} className="w-full sm:w-auto bg-blue-800 hover:bg-blue-600 text-white font-bold py-3 px-8 rounded-lg transition-transform hover:scale-105 shadow-lg shadow-blue-500/20 text-lg">
              Claim Your Free Profile
            </button>
            <a href="#" className="w-full sm:w-auto bg-gray-800/50 hover:bg-gray-800 border border-gray-700 text-gray-300 font-medium py-3 px-6 rounded-lg transition-colors flex items-center justify-center gap-2">
      ...
      <section id="open-source" className="py-16 md:py-24 bg-gray-950">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <a href="#" className="bg-white hover:bg-gray-200 text-gray-950 font-bold py-3 px-8 rounded-lg transition-transform hover:scale-105 inline-flex items-center gap-2">
              <i className="w-5 h-5">
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-4xl mx-auto items-stretch">
            <div className="bg-gray-800 border border-gray-800 rounded-2xl p-8 flex flex-col h-full">
              ...
              <a href="#" className="w-full text-center bg-gray-700 hover:bg-gray-600 text-white font-bold py-3 px-6 rounded-lg transition-colors">Get Started</a>
            </div>
            ...
            <div className="bg-gray-800 border rounded-2xl p-8 flex flex-col h-full relative border-blue-800 shadow-2xl shadow-blue-500/10">
              ...
              <a href="#" className="w-full text-center bg-blue-800 hover:bg-blue-600 text-white font-bold py-3 px-6 rounded-lg transition-transform hover:scale-105">Go Pro</a>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-gray-950">
        <div className="container mx-auto px-6 text-center">
          ...
          <button onClick={() => signIn("github", { callbackUrl })} className="bg-blue-800 hover:bg-blue-600 text-white font-bold py-4 px-10 rounded-lg transition-transform hover:scale-105 shadow-lg shadow-blue-500/20 text-xl">
            Get Started with CodeCred for Free
          </button>
        </div>
      </section>
    </>
